  ...
  <div x-data="{ flash: true }">
    <!-- @if(session()->has('success')) -->
      <div x-show="flash"
        ...
        role="alert"><strong class="font-bold">Success!</strong>
        <!-- <div>This is a flash message</div> -->
        <div>{{ session('success') }}</div>

        <span class="absolute top-0 right-0 px-4 py-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" @click="flash = false"
            fill="none" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 cursor-pointer">
