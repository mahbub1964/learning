...
$users = ['user2', 'user1', 'user3']; //, 10, true, null]; //var_dump($users);
...
// array_slice
$ids2 = array_slice($ids, 2, 3); //var_dump($ids2);
...
$tagsArr = explode(',', $tags); var_dump($tagsArr);
var_dump($tagsArr);
...
<body class="bg-gray-100">
  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="bg-white rounded-lg shadow-md p-6 mt-6">
      ...
      <h2 class="text-sl font-semibold my-4">IDs Array:</h2>
      <p>
        <pre>
          <?php print_r($ids); ?>
        </pre>
      </p>
      <h2 class="text-sl font-semibold my-4">Users Array:</h2>
      <p>
        <pre>
          <?php print_r($users); ?>
        </pre>
